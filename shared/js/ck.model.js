...
(function() {
  ...
  CK.Model = (function() {
    ...
    Model.configure = function(url, db) {
      ...
      CK.Model.createNecessaryCollections(['contributions', 'tags', 'states']);
      ...
      return tags.fetch({
        success: function(tags) {
          ...
          if (tags.find(function(t) {
            ...
            return console.log("Not creating 'N/A' tag because it already exists");
          } else {
    ...
    Model.createNecessaryDatabase = function(requiredDatabase, afterwards) {
  ...
  CK.Model.Document = (function(_super) {
  ...
  CK.Model.Collection = (function(_super) {
    ...
    Collection.prototype.model = CK.Model.Document;
